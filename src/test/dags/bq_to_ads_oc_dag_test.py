...
"""Tests for dags.bq_to_ads_oc_dag."""
...
class DAGTest(dag_test.DAGTest):
  ...
  def setUp(self) -> None:
    ...
    self.init_airflow_variables(bq_to_ads_oc_dag._DAG_NAME)
  ...
  def test_create_dag(self):
    ...
    self.verify_ads_oc_hook(test_dag.tasks[1].output_hook, is_var_prefixed)
