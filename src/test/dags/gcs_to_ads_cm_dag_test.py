...
"""Test for dags.gcs_to_ads_cm_dag.
"""

import unittest

import dag_test
from dags import gcs_to_ads_cm_dag
...
class DAGTest(dag_test.DAGTest):
  ...
  def setUp(self):
    ...
    self.init_airflow_variables(gcs_to_ads_cm_dag._DAG_NAME)
  ...
  def test_create_dag(self):
    ...
    test_dag = gcs_to_ads_cm_dag.GCSToAdsCMDag(
