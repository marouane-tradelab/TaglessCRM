...
"""Test for dags.gcs_to_ads_oc_dag_v2.
"""

import unittest

import dag_test
from dags import gcs_to_ads_oc_dag_v2
...
class DAGTest(dag_test.DAGTest):
  ...
  def setUp(self):
    ...
    self.init_airflow_variables(gcs_to_ads_oc_dag_v2._DAG_NAME)
  ...
  def test_create_dag(self):
    ...
    test_dag = gcs_to_ads_oc_dag_v2.GCSToAdsOCDagV2(
