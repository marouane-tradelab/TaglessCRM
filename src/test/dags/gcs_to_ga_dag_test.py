...
"""Tests for dags.gcs_to_ga_dag."""

import unittest

import dag_test
from dags import gcs_to_ga_dag
...
class DAGTest(dag_test.DAGTest):
  ...
  def setUp(self):
    ...
    self.init_airflow_variables(gcs_to_ga_dag._DAG_NAME)

  def test_create_dag(self):
    """Tests that returned DAG contains correct DAG and tasks."""
    expected_task_ids = ['gcs_to_ga_retry_task', 'gcs_to_ga_task']

    is_var_prefixed = False
    test_dag = gcs_to_ga_dag.GCSToGADag(
