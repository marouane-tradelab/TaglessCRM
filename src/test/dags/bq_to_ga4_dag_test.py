...
"""Tests for dags.bq_to_ga4_dag."""

import unittest

from dags import bq_to_ga4_dag
import dag_test
...
class DAGTest(dag_test.DAGTest):
  ...
  def setUp(self):
    ...
    self.init_airflow_variables(bq_to_ga4_dag._DAG_NAME)

  def test_create_dag(self):
    """Tests that returned DAG contains correct DAG and tasks."""
    expected_task_ids = ['bq_to_ga4_retry_task', 'bq_to_ga4_task']

    is_var_prefixed = False
    test_dag = bq_to_ga4_dag.BigQueryToGA4Dag(
