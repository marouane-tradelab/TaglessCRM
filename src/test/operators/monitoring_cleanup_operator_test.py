...
"""Tests for plugins.pipeline_plugins.operators.monitoring_cleanup_operator."""

import unittest
from unittest import mock

from plugins.pipeline_plugins.operators import monitoring_cleanup_operator as monitoring_cleanup_operator_lib
...
class MonitoringCleanupOperatorTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.monitoring_hook_path = (
        'plugins.pipeline_plugins.hooks'
